...
window.onload = function() {
	...
	$lightDarkBtn.onclick = function() {
		var cssType = window.localStorage["lightDarkCss"];
		if(cssType == "light"){
			window.localStorage["lightDarkCss"] = "dark";
			$lightDarkBtn.setAttribute("class", "fa fa-sun-o");
            $lightDarkBtn.setAttribute("title", "切换浅色模式");
			$lightDarkCss.href = "/css/style-dark.css";
		}else{
			window.localStorage["lightDarkCss"] = "light";
			$lightDarkBtn.setAttribute("class", "fa fa-moon-o");
            $lightDarkBtn.setAttribute("title", "切换深色模式");
